...
export const organizations = pgTable("organizations", {
  ...
  // Plan expiration timestamp. `null` means no expiry (e.g. internal/demo
  // accounts). When set and in the past, the dashboard enters read-only mode
  // until the super-admin extends it (Fase 3).
