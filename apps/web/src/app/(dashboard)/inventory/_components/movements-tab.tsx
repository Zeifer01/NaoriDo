...
> = {
  purchase: { label: "Compra distribuidora", variant: "default" },
  consumption: { label: "Saída manual", variant: "secondary" },
  fair_sale: { label: "Feira", variant: "outline" },
  waste: { label: "Perda", variant: "destructive" },
