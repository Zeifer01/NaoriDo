      ...
      >
        ...
        {tables.length === 0 && (
          <div className="absolute inset-0 flex items-center justify-center">
            <p className="text-muted-foreground">Nenhuma mesa para exibir</p>
          </div>
        )}
      </div>
      <p className="text-xs text-muted-foreground">
        Arraste as mesas para posicioná-las. Use a roda do mouse para zoom. Clique e arraste o fundo para navegar.
      </p>
    </div>
  );
}
