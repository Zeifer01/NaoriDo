  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-1 mt-auto">
        ...
        <IconBtn icon={<History className="h-3.5 w-3.5" />} title="Histórico" onClick={() => onHistory(table)} />
        {waiterAssignmentEnabled && (
          <IconBtn icon={<UserPlus className="h-3.5 w-3.5" />} title="Atribuir" onClick={() => onAssign(table)} />
        )}
