...
const allMethods = ["all", "cash", "card", "pix", "transfer", "other"];
  ...
  return (
    <>
      ...
      <SearchInput
        ...
        placeholder="Buscar por pedido ou referência..."
      />
            ...
            <table className="w-full">
              <thead>
                <tr className="border-b bg-muted/50">
                  ...
                  <th className="text-right p-3 text-sm font-medium text-muted-foreground hidden sm:table-cell">Gorjeta</th>
                  <th className="text-left p-3 text-sm font-medium text-muted-foreground hidden md:table-cell">Referência</th>
                  <th className="text-right p-3 text-sm font-medium text-muted-foreground hidden lg:table-cell">Data</th>
                ...
                {isLoading ? (
                  ...
                  <tr>
                    <td colSpan={7} className="p-8 text-center text-sm text-muted-foreground">
                      {search || methodFilter !== "all" ? "Nenhum pagamento encontrado" : "Nenhum pagamento registrado"}
                    </td>
                  </tr>
                ) : (
