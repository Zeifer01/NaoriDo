        ...
        <div className="space-y-4">
          <div className="space-y-2">
            ...
            <Select value={docType} onValueChange={handleDocTypeChange}>
              ...
              <SelectContent>
                <SelectItem value="boleta_simple">Recibo Simples</SelectItem>
                <SelectItem value="boleta_electronica">Recibo Eletrônico</SelectItem>
                <SelectItem value="factura">Nota Fiscal</SelectItem>
              </SelectContent>
            </Select>
          </div>
          ...
          {docType === "factura" && (
            <>
              ...
              <div className="space-y-2">
                <Label htmlFor="receiptRazonSocial">Razão Social</Label>
                <Input
