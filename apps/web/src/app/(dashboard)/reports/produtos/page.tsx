  ...
  return (
    <div className="space-y-4">
      ...
      <div className="report-print-root space-y-6">
        ...
        <ReportPrintTitle
          title="Produtos"
          subtitle="Ranking, mix e itens sem venda"
        />
        <AnalyticsDateToolbar
          title="Produtos"
          subtitle="Ranking, mix por categoria, margem (quando houver custo) e itens sem venda"
          state={dateState}
          onRefresh={() => refetch()}
        ...
        <div className="grid gap-6 lg:grid-cols-2">
          <div className="rounded-xl border bg-card overflow-hidden">
            <div className="p-4 border-b">
              <h2 className="text-sm font-semibold">Mais vendidos (receita)</h2>
            </div>
        ...
        <ReportPrintFooter title="Produtos" />
      </div>
    </div>
  );
}
